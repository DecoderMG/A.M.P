package com.dmgproductions.amp.visualizer.renderer;
...
import com.dmgproductions.amp.visualizer.AudioData;
import com.dmgproductions.amp.visualizer.FFTData;
...
public class CircleBarRenderer extends Renderer
{
  ...
  {
    this(paint, divisions, false, true);
  }
   ...
   */
  public CircleBarRenderer(Paint paint, int divisions, boolean cycleColor, boolean passedModulate)
  {
    super();
    mPaint = paint;
    mDivisions = divisions;
    mCycleColor = cycleColor;
    modulate = passedModulate;
  }
  ...
  public void onRender(Canvas canvas, FFTData data, Rect rect)
  {
    ...
    angleModulation += 0.78;
  }

  float modulation = 0;
  float modulationStrength = 0.5f; // 0-1
