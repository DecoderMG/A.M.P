...
import com.dmgproductions.amp.classifier.GestureClassifier;
import com.dmgproductions.amp.classifier.featureExtraction.NormedGridExtractor;
import com.dmgproductions.amp.recorder.GestureRecorder;
import com.dmgproductions.amp.recorder.GestureRecorderListener;
...
public class GestureRecognitionService extends Service implements GestureRecorderListener {
	...
	IBinder gestureRecognitionServiceStub = new IGestureRecognitionService.Stub() {
		...
		@Override
		public void callRecognition() throws RemoteException
		{
			recorder.callRecognition();
		}
	};
